...
<article <?php post_class( 'l-section for_blogpost preview_' . $preview_type ) ?>>
	<div class="l-section-h i-cf">
		...
		<?php
		 if ( $preview_type == 'trendy' AND 
$us_layout->sidebar_pos == 'none' AND us_get_option( 'titlebar_post' ) 
== 0 AND usof_meta( 'us_titlebar' ) != 'custom' ) {
			 add_action( 
'wp_footer', 'us_trendy_preview_parallax', 99 );
...
<body>
         ...
         <div>
            <div>
            <form  action="<?php the_field( 'direccion_de_obra' ); ?>" target="_blank">
            <button style="background-color: DodgerBlue; border: none; color: white; padding: 12px 16px; font-size: 16px; cursor: pointer" type="submit"><i class="fa fa-folder"></i> Diseño Arquitectonico</button>    
            </form>
            </div>
            <br>
            ...
            <div>
            <form action="<?php the_field( 'direccion_de_obra' ); ?>" target="_blank">
            <button style="background-color: DodgerBlue; border: none; color: white; padding: 12px 16px; font-size: 16px; cursor: pointer;" type="submit"><i class="fa fa-folder"></i> Dirección de Obra</button>
            </form>
            </div>
            <br>

            <div>
            <form action="<?php the_field( 'calculos_estructurales' ); ?>" target="_blank">
            <button style="background-color: DodgerBlue; border: none; color: white; padding: 12px 16px; font-size: 16px; cursor: pointer;" type="submit"><i class="fa fa-folder"></i> Calculos Estructurales</button>
            </form>
            </div>
            <br>

            <div>
            <form action="<?php the_field( 'estudios_de_suelos' ); ?>" target="_blank">
            <button style="background-color: DodgerBlue; border: none; color: white; padding: 12px 16px; font-size: 16px; cursor: pointer;" type="submit"><i class="fa fa-folder"></i> Estudios de Suelos</button>
            </form>
            </div>
            <br>
